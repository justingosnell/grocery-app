...
function setupEventListeners() {
    ...
    document.addEventListener('keydown', (e) => {
        // Enter adds item when focus is in item or quantity
        if (e.key === 'Enter' && (document.activeElement === itemInput || document.activeElement === quantityInput)) {
            e.preventDefault();
    ...
    // FAB mirrors add action
    if (fabAdd) {
        fabAdd.addEventListener('click', () => {
            if (itemInput.value.trim()) addItemForm.requestSubmit();
