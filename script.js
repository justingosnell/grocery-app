...
function handleClearList() {
    ...
    saveData('currentList', currentList);
    renderCurrentList();
    showAlert('Current list has been cleared.', 'success');
    updateSaveButtonState();
}
...
function setupEventListeners() {
    ...
    // Clear list button: quietly clear without confirmation modal
    if (clearListLink) {
    ...
    // Removed confirm/cancel listeners for the deleted modal
